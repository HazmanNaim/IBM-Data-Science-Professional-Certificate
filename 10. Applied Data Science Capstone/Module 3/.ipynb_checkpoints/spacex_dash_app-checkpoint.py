...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        filtered_df.columns = ['Launch Site', 'Success Count']
        ...
        fig = px.pie(site_df, values='class count', names='class', title=title)
        return fig
...
def get_scatter_chart(entered_site, payload_slider):
    ...
    slide=(spacex_df['Payload Mass (kg)'] > min_payload) & (spacex_df['Payload Mass (kg)'] < max_payload)
