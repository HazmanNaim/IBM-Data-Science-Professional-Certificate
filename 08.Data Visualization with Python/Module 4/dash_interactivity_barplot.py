'''
To run the application, run this script (e.g python3 dash_interactivity_barplot.py)
Launch the application from your port. Type in your application port (e.g 8050)
or
The terminal output this, "Dash is running on http://127.0.0.1:8050/""
'''
